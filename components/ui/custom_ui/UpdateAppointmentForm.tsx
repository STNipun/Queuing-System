...
export function UpdateAppointmentForm({ appointment, onSuccess }: UpdateAppointmentFormProps)
{
    ...
    const appointmentDate = typeof appointment.appointmentDate === "string"
    ...
    const onSubmit: SubmitHandler<UpdateAppointmentFormValues> = async (values) =>
    {
        setIsSaving(true);
        ...
        catch (error)
        {
            ...
            toast.error("Unexpected error while updating appointment");
        }
        finally
        {
            setIsSaving(false);
