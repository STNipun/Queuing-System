    ...
    <div className="px-6 lg:px-10 py-6 space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
          View diagnosis details from the Patient History table.
        </p>
      </div>
      ...
      {selectedVisit && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="w-full max-w-3xl max-h-[90vh] overflow-hidden rounded-2xl bg-[#161b26] shadow-2xl border border-white/8 flex flex-col">
